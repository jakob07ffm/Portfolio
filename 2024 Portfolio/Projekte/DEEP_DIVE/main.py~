...
pygame.display.set_caption("DEEP_DIVE")
...
while running:
    ...
    if air_bar_width > 100:
        air_bar_color = green
    if air_bar_width > 30 and air_bar_width < 100:
        air_bar_color = yellow
    if air_bar_width < 30:
        air_bar_color = red    
    ...
    arrow_image = pygame.image.load("Assets/pfeil.png")
    arrow_image_big = pygame.transform.scale(arrow_image, (50, 50))
    if player_y < 2100:
        win.blit(arrow_image_big, (495, 940))
    ...
    usage_air_bar = pygame.draw.rect(win, (air_bar_color), pygame.Rect(air_bar_x, air_bar_y, air_bar_width, air_bar_height))
    back_air_bar = pygame.draw.rect(win, black, pygame.Rect(back_air_bar_x, back_air_bar_y, back_air_bar_width, back_air_bar_height), 5)
